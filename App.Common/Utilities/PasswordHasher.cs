...
namespace App.Common.Utilities
{
    public sealed class PasswordHasher
    {
        ...
        public string HashPassword(string password)
        {
            ...
            byte[] salt;
            byte[] bytes;
            using (var rfc2898DeriveBytes = GetRfc2898DeriveBytes(password))
            {
        ...
        private Rfc2898DeriveBytes GetRfc2898DeriveBytes(string password)
        {
            return new Rfc2898DeriveBytes(password, SaltSize, Pbkdf2IterCount);
        }
